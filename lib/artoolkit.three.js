...
(
	...
	/*
				...
				videoEle.srcObj = video;
				document.body.appendChild(videoEle);
				
				videoEle.style.zindex = -2;
				*/
				this.setupThree();
	/*
				...
				if (this.orientation === 'portrait') {
					alert("protrait mode : rotate the screen");
					plane.rotation.z += Math.PI/2;
				}
	*/
				
				var scene1 = new THREE.Scene();
				var camera1 = new THREE.PerspectiveCamera(75,window.innerWidth,window.innerHeight,0.01,10000);
				camera1.matrixAutoUpdate = false;
				//camera.projectionMatrix.elements.set(this.getCameraMatrix());
				camera1.projectionMatrix.elements = this.getCameraMatrix();
	...
	//alert();
			...
			/*	{
					...
					this.renderOn = function(renderer) 
					{
						videoTex.needsUpdate = true;
